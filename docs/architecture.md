...
- training/: Organized training entrypoints
	- training/planner/: data generation, supervised training, RL fine-tuning for planner
	- training/generator/: data pipeline, supervised diffusion training, and RL adversarial training for generator
- adversarial/: unified adversarial entrypoint (generator vs planner) and supporting code
