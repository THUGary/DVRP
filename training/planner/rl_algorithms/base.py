...
class RLAlgorithm(ABC):
	...
	def begin_group(self, group_idx: int) -> None:
		"""Optional hook for algorithms that operate on episode groups (e.g., POMO)."""
		pass
	...
	def end_group(self) -> Dict[str, float]:
		"""Optional hook invoked after a collection of related episodes."""
		return {}
