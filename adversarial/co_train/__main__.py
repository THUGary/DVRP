...
def main() -> None:
    ...
    p.add_argument("--planner-ckpt-init", type=str, default="checkpoints/planner/planner_dynamic_20_2_200.pt", help="Initial checkpoint for model planner (if planner-type=model)")
    ...
    coevolution_loop(
        cfg,
        planner_type="model",
        planner_ckpt_init="checkpoints/planner/planner_dynamic_20_2_200.pt",
